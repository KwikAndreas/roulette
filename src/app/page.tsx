        ...
        <div className="bg-white rounded-lg p-6 mb-8 shadow-lg">
          <div className="flex gap-4 mb-4">
            <input
              ...
              className="flex-1 px-4 py-2 text-gray-700 font-bold border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
              disabled={isSpinning}
            />
            <button
              onClick={addItem}
          ...
          <div className="flex flex-wrap gap-2">
            {items.map((item, index) => (
              <div
                key={index}
                className="flex items-center bg-gray-100 px-3 py-1 rounded-full font-bold text-gray-600 text-sm"
              >
                <span>{item}</span>
                <button
            ...
            {items.length > 0 ? (
              <>
                ...
                <div className="relative mb-8">
                  ...
                  <div
                    ref={rouletteRef}
                    className="w-80 h-80 relative transition-transform duration-[3000ms] ease-out"
                    style={{
                ...
                <button
                  ...
                  className="px-8 py-4 bg-green-500 text-white text-xl font-bold rounded-full hover:bg-green-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors shadow-lg"
                >
        ...
        {selectedItem && (
          <div className="fixed inset-0 bg-black/60 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-8 max-w-md mx-4 text-center">
              ...
              <p className="text-xl mb-4">Item yang terpilih:</p>
